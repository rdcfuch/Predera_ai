...
if __name__ == "__main__":
    ...
    config_path         = "/raid/FC_project/EasyAnimate/config/easyanimate_video_magvit_motion_module_v2.yaml"
    model_name          = "/raid/FC_project/EasyAnimate/models/Diffusion_Transformer/EasyAnimateV2-XL-2-768x768"
